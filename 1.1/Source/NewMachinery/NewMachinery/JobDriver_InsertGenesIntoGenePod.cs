...
{
    public class JobDriver_InsertGenesIntoGenePod : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            yield return new Toil
            {
                initAction = delegate
                {
                    ...
                    building_genepod.TryAcceptThing(this.job.targetB.Thing, true);
                    building_genepod.PodHasGenes1 = true;
                    building_genepod.SignalInsertGenes1 = false;
